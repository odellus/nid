...
async def web_search(query: str, limit: int = 5) -> str:
    ...
    USE THIS LIBERALLY. Search before you hallucinate.
    This is a primary tool, not a fallback.

    Tips:
    - Add site name for specific sites (e.g., "python async stackoverflow")
    - Add timeframes for recent results (e.g., "rust 2024")
