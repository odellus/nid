...
class Agent(ACPAgent):
    ...
    def _process_response(self, response):
        ...
        for chunk in response:
            ...
            thinking, content, tool_calls, tool_call_id, new_token = self._process_chunk(
        ...
        return thinking, content, self._process_tool_call_inputs(tool_calls), final_usage
