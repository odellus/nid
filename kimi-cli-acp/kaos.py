...
class ACPProcess:
    ...
    def __init__(
        ...
        *,
        ...
        self._exit_future: asyncio.Future[int] = (
...
class ACPKaos:
    ...
    def __init__(
        ...
        *,
        ...
        self._supports_terminal = bool(
            client_capabilities and client_capabilities.terminal
        )
    ...
    async def stat(
        self, path: StrOrKaosPath, *, follow_symlinks: bool = True
    ) -> StatResult:
        ...
        *,
        ...
        if not self._supports_read:
            return await self._fallback.readtext(
                abs_path, encoding=encoding, errors=errors
            )
        response = await self._client.read_text_file(
            path=abs_path, session_id=self._session_id
        )
